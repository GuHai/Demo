...
@Controller
@RequestMapping(value = "/ForwardShareUserBeenrecruitedController")
public class ForwardShareUserBeenrecruitedController extends BaseController{

	@Autowired
	private ForwardShareUserBeenrecruitedService forwardShareUserBeenrecruitedService;

	private final static Logger logger = LoggerFactory.getLogger(ForwardShareUserBeenrecruitedController.class);
