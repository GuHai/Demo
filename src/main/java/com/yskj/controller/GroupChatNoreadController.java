...
@Controller
@RequestMapping(value = "/GroupChatNoreadController")
public class GroupChatNoreadController extends BaseController{

	@Autowired
	private GroupChatNoreadService groupChatNoreadService;

	private final static Logger logger = LoggerFactory.getLogger(GroupChatNoreadController.class);
