...
//        HttpPost httppost = new HttpPost("http://localhost:8080/myDemo/Ajax/serivceJ.action");
     ...
     */
    public static String  post(String url,String xml) throws IJobException {
        String result  = "";
        // 创建默认的httpClient实例.
        CloseableHttpClient httpclient = HttpClients.createDefault();
        // 创建httppost
        ...
        try {
            ...
            e.printStackTrace();
            throw new IJobException("客户端异常");
        } catch (UnsupportedEncodingException e1) {
            e1.printStackTrace();
            throw new IJobException("编码异常");
        } catch (IOException e) {
            e.printStackTrace();
            throw new IJobException("IO异常");
        } finally {
            // 关闭连接,释放资源
            try {
                httpclient.close();
   ...
   /* public static Map<String,String> getWinxinResultAndTransCode(String url){
    ...
    public static Map<String,Object> getObjectResult(String url){
