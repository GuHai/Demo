...
//        char [] password = {'1','4','9','7','2','6','2','1','4','2'};
        char[] password = DictCacheService.MerchantNo.toCharArray();
        /**
        ...
        FileInputStream instream = new FileInputStream(new File("/path/to/apiclient_cert.p12"));//P12文件目录
        try {
            /**
             * 此处要改
             *
