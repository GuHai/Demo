...
public class Result implements java.io.Serializable {
	...
	public void byDelete(long num){
		this.code = SUCCESS;
		this.msg = "删除成功，"+num+"条记录被删除";
	}
	public void byInsert(long num){
		this.code = SUCCESS;
		this.msg = "新增成功，"+num+"条记录被插入";
	}
	...
	public void listData(Object object){
		ListPack listPack = new ListPack(object);
		this.setData(listPack);
	}

	public List fromDataList(){
