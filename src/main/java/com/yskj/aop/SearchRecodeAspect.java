package com.yskj.aop;

import com.google.gson.Gson;
import com.yskj.models.Browserecord;
import com.yskj.models.QueryParam;
import com.yskj.models.Searchlog;
import com.yskj.service.BrowserecordService;
...
import com.yskj.aop.SearchRecode.OpType;
...
public class SearchRecodeAspect {
    ...
    @Pointcut("@annotation(com.yskj.aop.SearchRecode)")
    ...
    public  void doAfter(JoinPoint joinPoint) {
        try {
            ...
            }else if(type.equals(OpType.BROWSE_FULL)){
                addBrowse(joinPoint,2);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
