        ...
        <div class="rich_media_area_primary">
            <div id="img-content">
                ...
                <div class="rich_media_meta_list">
                    ...
                    <em class="rich_media_meta rich_media_meta_text">${news.author}</em>
                            ...
                            <div style="margin: 30px;float: left" >
                                ...
                                <div class="btnBox">
                                    <span  style="padding:2px 20px;position: relative;top: 30%;transform: translateY(-30%);border: 1.5px solid #19A7F8;border-radius : 15px;">
                                        <a style="text-decoration:none" href="https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=${gzh}==&scene=124#wechat_redirect" >关注</a>
                                    </span>
                                </div>
                            </div>
                        </div>
