<%@ page contentType="text/html;charset=UTF-8" language="java" import="com.yskj.utils.IJobSecurityUtils"%>
...
<head>
    ...
    <script src="/ijob/static/js/information/ijob/lib-flexible.js"></script>
    <link rel="stylesheet" type="text/css" href="/ijob/static/css/infprmation/bootstrap.css"/>
    <link rel="stylesheet" type="text/css" href="/ijob/static/css/infprmation/jquery-ui.css"/>
    <link rel="stylesheet" type="text/css" href="/ijob/static/css/infprmation/webim_demo.css"/>
    <link rel="stylesheet" type="text/css" href="/ijob/static/css/infprmation/bootstrap-table.css"/>
...
<div class="aio" id="webim_demo">
    <input type="hidden" value="<shiro:principal property="weChatNo"/>" id="IJobUserName">
    <input type="hidden" value="<shiro:principal property="userSig"/>" id="IJobUserSig">
    <input type="hidden" value="${sessionScope.headImg}" id="IJobInfoHeadImg">
    <input type="hidden" value="<shiro:principal property="nickName"/>" id="IJobNickName">
    <div class="titlebar">
        <img id="p_my_face"/>
        <img class="t_img" src="/ijob/static/images/icon-return-@3x.png" alt="" onclick="onClose()">
        <p id="t_my_name"></p>
        <ul id="t_my_menu">
            <li>菜单
                <ul>
    ...
    <div class="chatpart">
        ...
        <div class="sendbar">
            <input  type="text" class="msgedit" id="send_msg_text" onkeydown="onTextareaKeyDown()"></input>
        ...
        <div class="editbar">
            ...
            <a class="chat02_title_btn ctb03" title="选择图片" onclick="selectPicClick()" href="javascript:void(0);"> </a>
            ...
            <div class="modal-body">
                <form class="form-inline" role="form" id="sp_form" name="sp_form">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sp_to_account" placeholder="请输入用户ID"
                               value="test1101" maxlength="50" onkeydown="if(event.keyCode==13)return false;">
                    </div>
                    <button type="button" class="btn btn-default" onclick="searchProfileByUserId()">搜索</button>
                    <!--onclick="applyAddFriend()"-->
                </form>
...
<!-- /.modal -->
<!--申请加好友-->
<div class="modal fade" id="add_friend_dialog" tabindex="-1" role="dialog" aria-labelledby="add_friend_dialog_label"
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="af_to_account" placeholder="请输入对方帐号"
                                   readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" onkeydown="if(event.keyCode==13)return false;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="df_to_account" placeholder="请输入对方帐号"
                                   readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
...
<!-- /.modal -->
<!--最近联系人-->
<div class="modal fade" id="get_recent_contact_list_dialog" tabindex="-1" role="dialog"
     aria-labelledby="get_recent_contact_list_dialog_label" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog-wide">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×
...
<div class="modal fade" id="set_profile_portrait_dialog" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" onkeydown="if(event.keyCode==13)return false;" id="spp_form"
                      name="spp_form">
                    <div class="form-group">
                        <label for="spp_image" class="col-sm-2 control-label">头像URL</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="spp_image" placeholder="请输入头像URL"
                                   maxlength="100">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="spp_allow_type_radio" id="spp_allow_type_allow_any_radio"
                                       value="AllowType_Type_AllowAny" checked> 允许任何人
                            </label>
                            <label class="radio-inline">
...
<!-- /.modal -->
<!--我的好友申请-->
<div class="modal fade" id="get_pendency_dialog" tabindex="-1" role="dialog" aria-labelledby="get_pendency_dialog_label"
     aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog-wide">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" onkeydown="if(event.keyCode==13)return false;">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="rf_to_account" placeholder="请输入对方帐号"
                                   readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
...
<!-- /.modal -->
<div class="modal fade" id="create_group_dialog" tabindex="-1" role="dialog" aria-labelledby="create_group_dialog_label"
     aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="cg_form" name="cg_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="cg_id" value="" placeholder="请输入自定义群ID"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="cg_type_radio" id="cg_type_chat_room_radio" value="ChatRoom"
                                       checked> 聊天室
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="cg_type_radio" id="cg_type_public_radio" value="Public"> 公开群
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="cg_type_radio" id="cg_type_private_radio" value="Private"> 私有群
                                <!--私有群即讨论组-->
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="cg_type_radio" id="cg_type_private_radio" value="AVChatRoom">
                                直播聊天室
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="cg_faceurl" value="" placeholder="请输入群头像URL"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="cg_name" value="" placeholder="请输入群名称"
                                   maxlength="30" onkeydown="if(event.keyCode==13)return false;">
                        </div>
                    </div>
                    <div class="form-group">
...
<!-- /.modal -->
<div class="modal fade" id="search_group_dialog" tabindex="-1" role="dialog" aria-labelledby="search_group_dialog_label"
     aria-hidden="true" data-backdrop="static">
            ...
            <div class="modal-body">
                <form class="form-inline" role="form" id="sg_form" name="sg_form">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sg_group_id" value="" placeholder="请输入群ID"
                               maxlength="20" onkeydown="if(event.keyCode==13)return false;">
                    </div>
...
<!-- /.modal -->
<div class="modal fade" id="search_group_by_name_dialog" tabindex="-1" role="dialog"
     aria-labelledby="search_group_by_name_dialog_label" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog-full">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×
            ...
            <div class="modal-body">
                <form class="form-inline" role="form" id="sgbn_form" name="sgbn_form">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sgbn_group_name" value="" placeholder="请输入群名称(完全匹配)"
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="ajg_form" name="ajg_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="ajg_group_name" placeholder=""
                                   readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
...
<!-- /.modal -->
<div class="modal fade" id="get_my_group_dialog" tabindex="-1" role="dialog" aria-labelledby="get_my_group_dialog_label"
     aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog-wide">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="modify_group_msg_flag_dialog" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" onkeydown="if(event.keyCode==13)return false;" id="mgmf_form"
                      name="mgmf_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="mgmf_msg_flag_radio" id="mgmf_mf_d_radio" value="Discard"> 屏蔽
                            </label>
                        </div>
                    </div>
                </form>
...
<div class="modal fade" id="modify_group_member_dialog" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" onkeydown="if(event.keyCode==13)return false;" id="mgm_form"
                      name="mgm_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="mgm_account" placeholder="请输入要修改的成员帐号"
                                   readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group" id="mgm_role_div">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="mgm_role_radio" id="mgm_role_admin_radio" value="Admin"> 管理员
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="mgm_role_radio" id="mgm_role_member_radio" value="Member"> 成员
                            </label>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" onkeydown="if(event.keyCode==13)return false;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="dgm_account" placeholder="请输入要删除成员帐号"
                                   readonly="readonly">
                        </div>
                    </div>
                    <!--<div class="form-group">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" onkeydown="if(event.keyCode==13)return false;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="hijg_action_radio" id="hijg_action_agree_radio" value="Agree"
                                       checked> 同意
                            </label>
                            <label class="radio-inline">
...
<!-- /.modal -->
<div class="modal fade" id="modify_group_dialog" tabindex="-1" role="dialog" aria-labelledby="modify_group_dialog_label"
     aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="mg_form" name="mg_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="mg_faceurl" placeholder="请输入群头像URL"
                                   maxlength="100" onkeydown="if(event.keyCode==13)return false;">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="mg_name" placeholder="请输入群名称" maxlength="30"
                    ...
                    <div class="form-group" id="shut_up_all_role_div">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="mgm_role_radio" id="shut_up_all_member" value="On"> 全局禁言
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="mgm_role_radio" id="shut_up_all_member" value="Off"> 取消禁言
                            </label>
                        </div>
                    </div>
                </form>
...
<!-- /.modal -->
<div class="modal fade" id="change_group_owner_dialog" tabindex="-1" role="dialog"
     aria-labelledby="change_group_owner_dialog_label" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="cgo_form" name="cgo_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="cgo_new_owner" placeholder="请输入新群主ID"
                                   maxlength="50" onkeydown="if(event.keyCode==13)return false;">
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" onkeydown="if(event.keyCode==13)return false;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="agm_account" placeholder="请输入要邀请成员帐号"
                                   readonly="readonly">
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="fsm_form" name="fsm_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="fsm_account" placeholder="请输入要修改的成员帐号"
                                   readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="fsm_shut_up_time" placeholder="请输入禁言时间"
                                   maxlength="8" onkeydown="if(event.keyCode==13)return false;">
                        </div>
                    </div>
                </form>
            </div>
...
<!-- /.modal -->
<div class="modal fade" id="send_c2c_msg_dialog" tabindex="-1" role="dialog" aria-labelledby="send_c2c_msg_dialog_label"
     aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="scm_form" name="scm_form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="scm_to_account" placeholder=""
                                   readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="scm_content" placeholder="请输入消息内容"
                                   onkeydown="if(event.keyCode==13)return false;">
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="sgm_form" name="sgm_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="sgm_to_groupid" placeholder=""
                                   readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="sgm_content" placeholder="请输入消息内容"
                                   onkeydown="if(event.keyCode==13)return false;">
                        </div>
                    </div>
                </form>
...
<!-- /.modal -->
<div class="modal" id="select_app_dialog" tabindex="-1" role="dialog" aria-labelledby="select_app_dialog_label"
     aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" onkeydown="if(event.keyCode==13)return false;">
                    ...
                    <div class="form-group" id="sdkAppIdDiv">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="sdk_app_id" placeholder="请输入SdkAppId" value="1400070635">
                        </div>
                    </div>
...
<!-- /.modal -->
<!--用户登录+++++++++++++++++++++++++++++++-->
<div class="modal fade" id="login_dialog" tabindex="-1" role="dialog" aria-labelledby="login_dialog_label"
     aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<!-- /.modal -->
<!--发送文件-->
<div class="modal fade" id="upload_file_low_ie_dialog" tabindex="-1" role="dialog"
     aria-labelledby="upload_file_low_ie_dialog_label" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×
            ...
            <div class="modal-body">
                <form id="updli_file_form" enctype="multipart/form-data" class="form-horizontal" role="form"
                      onkeydown="if(event.keyCode==13)return false;">
                    <div class="form-group">
                        <label for="File" class="col-sm-2 control-label">选择</label>
                        <div class="col-sm-10">
...
<div class="modal fade" id="upload_pic_dialog" tabindex="-1" role="dialog" aria-labelledby="upload_pic_dialog_label"
     aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<!-- /.modal -->
<div class="modal fade" id="upload_file_dialog" tabindex="-1" role="dialog" aria-labelledby="upload_file_dialog_label"
     aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" onkeydown="if(event.keyCode==13)return false;"
                      id="upd_file_form" name="upd_file_form">
                    <div class="form-group">
                        <label for="File" class="col-sm-2 control-label">选择</label>
                        <div class="col-sm-10">
...
<!-- /.modal -->
<div class="modal fade" id="click_pic_dialog" tabindex="-1" role="dialog" aria-labelledby="click_pic_dialog_label"
     aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<!-- /.modal -->
<!-- 模态框（Modal） -->
<div class="modal fade" id="handle_ajg_dialog" tabindex="-1" role="dialog" aria-labelledby="handle_ajg_dialog_label"
     aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" onkeydown="if(event.keyCode==13)return false;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="hajg_group_id" placeholder=""
                                   readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="hajg_to_account" placeholder=""
                                   readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="hajg_action_radio" id="hajg_action_agree_radio" value="Agree"
                                       checked> 同意
                            </label>
                            <label class="radio-inline">
...
<!-- /.modal -->
<div class="modal fade" id="edit_custom_msg_dialog" tabindex="-1" role="dialog" aria-labelledby="edit_custom_msg_label"
     aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" onkeydown="if(event.keyCode==13)return false;" id="ecm_form"
                      name="ecm_form">
                    <div class="form-group">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="sgsm_form" name="sgsm_form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="sgsm_group_id" placeholder="请输入群组ID"
                                   maxlength="30">
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript" src="/ijob/static/js/information/ijob/lib/jquery/jquery.js"></script>
<script type="text/javascript" src="/ijob/static/js/information/ijob/lib/jquery/jquery-ui.js"></script>
<script type="text/javascript" src="/ijob/static/js/information/ijob/lib/lodash.min.js"></script>
<script type="text/javascript" src="/ijob/static/js/information/ijob/lib/bootstrap/bootstrap.js"></script>
<script type="text/javascript" src="/ijob/static/js/information/ijob/lib/bootstrap/bootstrap-table.js"></script>
<script type="text/javascript" src="/ijob/static/js/information/ijob/lib/bootstrap/bootstrap-collapse.js"></script>
<script type="text/javascript" src="/ijob/static/js/information/ijob/lib/xss.js"></script>
<!--TLS web sdk(只用于托管模式，独立模式不用引入)-->
<%--<script type="text/javascript" src="https://tls.qcloud.com/ijob/libs/api.min.js"></script>--%>
<!--用于获取文件MD5 js api(发送图片时用到)-->
<script type="text/javascript" src="/ijob/static/js/information/ijob/lib/md5/spark-md5.js"></script>
<!--web im sdk-->
<script type="text/javascript" src="/ijob/static/sdk/information/sdk/webim.js"></script>
<!--<script type="text/javascript" src="sdk/webim.min.js"></script>-->
<script type="text/javascript" src="/ijob/static/sdk/information/sdk/json2.js"></script>
<!--web im sdk 登录 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/login/login.js"></script>
<!--web im sdk 登出 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/logout/logout.js"></script>
<!--web im 解析一条消息 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/common/show_one_msg.js"></script>
<!--web im sdk 资料管理 api 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/profile/profile_manager.js"></script>
<!--web im sdk 好友管理 api 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/friend/friend_manager.js"></script>
<!--web im sdk 好友申请管理 api 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/friend/friend_pendency_manager.js"></script>
<!--web im sdk 好友黑名单管理 api 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/friend/friend_black_list_manager.js"></script>
<!--web im sdk 最近联系人 api 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/recentcontact/recent_contact_list_manager.js"></script>
<!--web im sdk 群组管理 api 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/group/group_manager.js"></script>
<!--web im sdk 群成员管理 api 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/group/group_member_manager.js"></script>
<!--web im sdk 加群申请管理 api 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/group/group_pendency_manager.js"></script>
<!--web im 切换聊天好友或群组 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/switch_chat_obj.js"></script>
<!--web im sdk 获取c2c获取群组历史消息 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/msg/get_history_msg.js"></script>
<!--web im sdk 发送普通消息(文本和表情) api 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/msg/send_common_msg.js"></script>
<!--web im sdk 上传和发送图片消息 api 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/msg/upload_and_send_pic_msg.js"></script>
<!--web im sdk 上传和发送文件消息 api 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/msg/upload_and_send_file_msg.js"></script>
<!--web im sdk 切换播放语音消息 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/msg/switch_play_sound_msg.js"></script>
<!--web im sdk 发送自定义消息 api 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/msg/send_custom_msg.js"></script>
<!--web im sdk 发送群自定义通知 api 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/msg/send_custom_group_notify_msg.js"></script>
<!--web im 监听新消息(c2c或群) 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/msg/receive_new_msg.js"></script>
<!--web im 监听群系统通知消息 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/msg/receive_group_system_msg.js"></script>
<!--web im 监听好友系统通知消息 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/msg/receive_friend_system_msg.js"></script>
<!--web im 监听资料系统通知消息 示例代码-->
<script type="text/javascript" src="/ijob/static/js/information/msg/receive_profile_system_msg.js"></script>
<script type="text/javascript">
    //帐号模式，0-表示独立模式，1-表示托管模式
    var accountMode = 0;

    //官方 demo appid,需要开发者自己修改（托管模式）
    var sdkAppID = 1400070635;
    var accountType = 22243;

    /*independentModeLogin($("#IJobUserName").val(),$("#IJobUserSig").val());*/
    //当前用户身份
    var loginInfo = {
        'sdkAppID': sdkAppID, //用户所属应用id,必填
        'accountType': accountType, //用户所属应用帐号类型，必填
        'identifier': $("#IJobUserName").val(), //当前用户ID,必须是否字符串类型，必填
        'userSig': $("#IJobUserSig").val(), //当前用户身份凭证，必须是字符串类型，必填
        'appIDAt3rd':sdkAppID,
...
<!--web im demo 基本逻辑-->
<script type="text/javascript" src="/ijob/static/js/information/base.js"></script>
</body>
</html>
