...
<footer class="foot">
    <a href="/h5/zp/home" class="unselected home"  data-menu="findJob">
        <span class="iconfont icon-zhuye" data-icon="icon-zhuye"></span>
        <p>首页</p>
    </a>
    <a href="/h5/zp/myJobIndex" class="unselected myJob"  data-menu="myjob">
        <span class="iconfont icon-jianzhi" data-icon="icon-jianzhi"></span>
        <p>我的招聘</p>
    </a>
    <a href="/h5/information/information" class="unselected information" data-menu="information">
        <span class="iconfont icon-xiaoxi" data-icon="icon-xiaoxi"></span>
        <p>信息</p>
        <i id="socketInfoTag" ></i>
    </a>
    <a href="/h5/qz/mine/mine" class="unselected hd" data-url="/ijob/api/PositionController/hasDSHPosition"  data-menu="personal">
