...
.wrap .summary{background:#fff;height:auto;padding:0.4rem 0.453rem;}
...
<div class="wrap">
    <div class="summary" style="margin-top:1.173rem;">
    ...
    <dl class="details">
        ...
        <h1>自我评价</h1></dt>
        <dd>
            <p>今年16岁，身高1.73，体重50公斤。执着于做自己喜欢做的事情，凡是只求做到更好，我相信不管过程是怎么样的，结果才重要。</p>
        </dd>
        <dt>
        <h1>教育背景</h1>
        </dt>
        <dd>
            <div class="school">
                <h2>湖南涉外经济学院</h2>
                <div class="discipline"  style="margin-top:0.267rem;">
                    <p>计算机与科技<span class="line"></span>本科</p>
                    <p>2015-至今</p>
                </div>
                <p class="specialty"  style="margin-top:0.267rem;">本人在大学期间一直在从事兼职行业，对兼职行业有比较深入的了解。
                </p>
            </div>
            <div class="school">
                <h2>筒口县第一中学</h2>
