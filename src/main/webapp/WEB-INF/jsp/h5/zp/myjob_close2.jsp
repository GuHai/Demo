...
.wrap .summary{border-top:1px solid #d7d7d7;border-bottom:0px;margin-top:0.267rem;margin-bottom:0.267rem;background:#fff;padding:0.267rem 0.453rem;height:auto;}
</style>

<div class="wrap">
	<div class="h-close">车展模特急招</div>
	<div class="summary">
		<div class="headerImg"><img class="headerImg" src="../../images/touxian.jpg" alt=""></div>
        <div class="contentBox">
            <p>
                张三 <span style="margin:5px;">|</span><span style="margin:0px;">本科</span>
            </p>
            <p>19岁</p>
        </div>
    </div>
	<form name="form" action=""  method="post">
		<div class="h-Cform">
			<div class="h-Cf-put">
				<span class="h-Cf-putsp">￥</span>
				<input type="number" class="putbox" name="" placeholder="请填写需要结算的金额" />
			</div>
			<div class="h-Cf-put">
				<div class="h-Cf-putd">添加备注<span>（最多50个字符）</span></div>
				<textarea name="" class="putTbox" placeholder="请填写备注"></textarea>
			</div>
		</div>
        <div id="Demo">
		...
		<div id="CalendarMain">
  			<div id="title"> 
				<a class="selectBtn month iconfont icon-weixinjiangzuofanhui" onClick="CalendarHandler.CalculateLastMonthDays();"></a>
				<div class="h-timebox">
				...
				<a class="selectBtn nextMonth iconfont icon-arrow-right" href="javascript:" onClick="CalendarHandler.CalculateNextMonthDays();"></a>
			</div>
  			<div id="context">
                <div class="week">
                  <h3 style="color:#108ee9;"> 日 </h3>
                  <h3> 一 </h3>
                  <h3> 二 </h3>
                  <h3> 三 </h3>
                  <h3> 四 </h3>
                  <h3> 五 </h3>
                  <h3 style="color:#108ee9;margin-top:0.187rem;"> 六 </h3>
                </div>
                <div id="center">
                  <div id="centerMain">
		...
		<ul class="h-Clist mb65">
			<li>
				<div class="h-ClistP1">
					申请时间:  2017年12月24日  19:32:20
					<span>待处理</span>
				</div>
				<div class="h-ClistP2">申请原由:  由于个人原由，不能继续工作，特此申请结算，希望老板能同意希望老板能同意希望老板能同意希望老板能同意希望老板能同意</div>
			</li>
			<li>
				<div class="h-ClistP1">
					申请时间:  2017年12月24日  19:32:20
				...
				<div class="h-ClistP2">申请原由:  由于个人原由，不能继续工作，特此申请结算，</div>
			</li>
		</ul>
		<div class="mui-hbutton rx_fixed">
