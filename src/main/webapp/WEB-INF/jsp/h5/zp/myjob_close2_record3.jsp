...
<style>
.mui-checkbox, .mui-radio{float:left;width:0.8rem;height:0.8rem;margin-top:0.4rem;}
...
<div class="JobV JobVtwo">
	<a href="javascript:void(0);" onclick="ijob.gotoPage({path:'/h5/zp/myjob_close_apply'})" class="">申请结算</a>
	...
	<a href="javascript:void(0);" onclick="ijob.gotoPage({path:'/h5/zp/myjob_close2_record3'})" class="JobVon">结算薪资</a>
 </div>
