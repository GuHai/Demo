...
<div class=wrap>
    <ul class="tabList" <%--style="display:none"--%>>
        <li class=""><a href="javascript:void(0);">待结算</a></li>
        ...
        <div class="datalist">
            <div class="accountsList">
                ...
                <div class="account-list-ul wait-list" style="margin-top: 0;">
                    <ul class="clearfix" style="padding-top: 1.333rem">
                            ...
                            <li class="posi-list">
                                ...
                                <div class="edit-btns">
                                    ...
                                    <div class="right">
                                        ...
                                        <a href="javascript:void(0);" class="salary-btn" onclick="ijob.gotoPage({path:'/h5/zp/paysalary/payMoney?scanSettle.id={{posi.id}}'})">发工资</a>
                                        {{/if}}
                                    </div>
                                </div>
                            </li>
                        ...
                        <script type="text/html" id="yjstemplate" data-url="/ijob/api/ApplySettlementController/getQrcodeYJSInfo" >
                            {{each list as posi}}
                                <li class="posi-list">
                                    ...
                                    <div class="edit-btns">
                                        <a href="javascript:void(0);" class="moreview" onclick="ijob.gotoPage({path:'/h5/zp/paysalary/payEndInfo?scanSettle.id={{posi.id}}'})">查看详情</a>
                                    </div>
                                </li>
                            {{/each}}
                        </script>
...
<script>
    ...
    $(".tabList>li").on("click", function () {
        if($(this).text()=="待结算"){
            ijob.storage.set("menu","DJS");
        }else{
            ijob.storage.set("menu","YJS");
        }
    ...
    if(ijob.storage.get("menu")=="YJS"){
        $(".tabList>li").eq(1).click();
    }else{
    ...
    function initQrcode(code,title,salary){
        ...
        var urlQrcode = "${site}/share/JS/" + code+"/money";
    ...
    function initYjs(){
        $("#yjstemplate").loadData().then(function (result) {
            if(result.data == null || result.data.list.length == 0){
                $(".nodata").remove();
                $(".yjs").attr("style","height:70%");
                $(".yjs").after("<div class='nodata'  class=\"hd_result\">\n" +
                    "            <div class=\"icon\">\n" +
