...
function onClose() {
    ...
    // 列表页
    document.getElementsByClassName("chatpart")[0].style.display = "none";

    // 聊天页
    document.getElementsByClassName("sesspart")[0].style.display = "block";
