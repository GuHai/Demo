...
function addSess(sess_type, to_id, name, face_url, unread_msg_count, sesslist, addPositonType) {
    ...
    sessDiv.onclick = function () {
        // 列表页
        var chatpart = document.getElementsByClassName("chatpart")[0];
        // 聊天页
        var sesspart = document.getElementsByClassName("sesspart")[0];
        $(".titlebar").css("display","block");
        sesspart.style.display = "none";
        chatpart.style.display = "block";
