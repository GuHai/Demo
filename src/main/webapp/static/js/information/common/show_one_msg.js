...
function addMsg(msg,prepend) {
    ...
    //对方发的信息
    if (!isSelfSend){
        msghead.style.color = "#a0a0a0";
        msgPre.style.backgroundColor="#fff";
        msgPre.style.float = "left";
        msgbody.className = "clearfix";
        msgPre.style.marginLeft="20px";

         //昵称  消息时间
        msghead.innerHTML = "&nbsp;&nbsp;" + webim.Tool.formatText2Html(webim.Tool.formatTimeStamp(msg.getTime()));
        msgbody.innerHTML="<img class='headurlClass' src='" + fromAccountImage + "' style='float:left'>";
    }

    //自己发的信息
    if(isSelfSend){
        msgbody.style.clear="both";
        msgPre.style.backgroundColor="pink";
        msgPre.style.float = "right";
        msgbody.className = "clearfix";
        msgPre.style.marginRight="20px";

         //昵称  消息时间
        // msghead.innerHTML =webim.Tool.formatText2Html( webim.Tool.formatTimeStamp(msg.getTime()));
        msgbody.innerHTML="<img class='headurlClass' src='" + fromAccountImage + "' style='float: right'>";
    }
