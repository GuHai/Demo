...
var attachment  = {
    ...
    cutImage:function(file,src,name,refid,type){
    ...
    $.fn.attachment  = function(){
        ...
        function render(i,item){
            if($(item).get(0).tagName == 'IMG'){
                ...
                $("body").append("  <div class='photo-mask' style='display: block;" +
                    ...
                    "        <div id=\"view\" style='margin: 0 auto;width: 200px;height: 200px;'></div>" +
                    "    </article>" +
                    "    </div>");
                ...
                $("#clipArea").photoClip({
                    ...
                    clipFinish: function(dataURL) {
                        // console.log(dataURL);
                        attachment.cutImage($("#file"),dataURL,name,refid,type);
                    }
                });



               // $(item).after("<input id='file' type='file' name = 'pic' accept = 'image/!*' onchange = \"attachment.cutImage(\'"+name+"\',\'"+refid+"\',\'"+type+"\',\'"+editable+"\')\" hidden='hidden'/>");
